...
def main():
    ...
    load2 = {'Load': 'Load2', 'Demand': 201, 'Location': 2}
    load3 = {'Load': 'Load3', 'Demand': 500, 'Location': 3}

    last = [load1, load2, load3]
    # P_2^d = 201 : P_1 = 684.8333333333333, P_3 = 
    # P_2^d = 200 : P_1 = 683.3333333333333, P_3 = 216.66666666666669
...
def DCOPF_model(PGmax, C, D, linecap, substation):
    ...
    model.linecap = pyo.Param(model.l, initialize={'L12': 500, 'L13': 500, 'L23': 100})
    ...
    for n in model.n:
        print(f"Theta by {n}: {model.theta[n].value} angle")
